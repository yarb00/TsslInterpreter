...
internal static partial class StringExtensions
{
	...
	public static bool IsAlphaNumericWithUnderscores(this string @string) => Regex_AlphaNumericWithUnderscores().IsMatch(@string);
	public static bool IsAlphaNumericWithSpaces(this string @string) => Regex_AlphaNumericWithSpaces().IsMatch(@string);
